...
if (isset($_POST["answer"])) {
    ...
    $answer = $_POST["answer"];
    if ($answer === 'yes') {
        header('location:going-to-sleep.php');
    } else if ($answer === 'no') {
        header('location:do-something.php');
    } else {
...
<html lang="en" >
    ...
    <head>
        <meta charset="UTF-8">
        <meta http-equiv="refresh" content="8;url=go-to-sleep.php" />
    ...
    <body onload="startDictation()">
        <div style="display: none">
            <audio src="sounds/sleep.mp3" autoplay></audio>
