...
<head>
    ...
    <meta charset="UTF-8">
    <meta http-equiv="refresh" content="600;url=read-mail.php" />
...
<body style="background: black" onload="startDictation()">
    ...
    <div class="text" style="height: 100%;width: 100%;margin:0px;background: none">
        ...
        <article style="display: none">
            ...
            <?php
            $sql = "SELECT * FROM `replies` WHERE status = '0' AND username='$username' ";
            ...
            ?>
                    <h1 style="letter-spacing: 20px;">The new reply was given at : <?php echo $row['replytime'] ?></h1>
