...
if (isset($_POST["answer"])) {
    ...
    $answer = $_POST["answer"];
    if ($answer === 'email') {
        header('location:../check/email/check.php');
    } else if ($answer === 'message') {
        header('location:../check/message/check.php');
...
<head>
    ...
    <meta charset="UTF-8">
    <meta http-equiv="refresh" content="10;url=what-to-check.php" />
...
<body style="background: black" onload="startDictation()">
    ...
    <div class="text">
        <div style="display: none">
            <iframe src="sounds/check-what.mp3" allow="autoplay"></iframe>
