...
if (isset($_POST["answer"])) {
    ...
    if ($answer === 'email') {
        ...
        header('location:../message/username.php');
    }else if ($answer === 'check') {
        header('location:what-to-check.php');
    } else {
...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <meta http-equiv="refresh" content="12;url=access-granted.php" />
    ...
    <body style="background: black" onload="startDictation()">
        ...
        <div class="text">
            <div style="display: none">
                <iframe  src="sounds/access-granted.mp3" allow="autoplay" ></iframe>
