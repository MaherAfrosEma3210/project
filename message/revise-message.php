...
if (isset($_POST["answer"])) {
    ...
    if ($answer === 'yes') {
        ...
        header('location:revise-message.php');
    } else {
...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <meta http-equiv="refresh" content="100;url=revise-message.php" />
            ...
            <article style="display: none">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ?>
                        <h1 style="letter-spacing: 20px;" >You are sending Mail TO : <?php echo $row['username'] ?></h1>
